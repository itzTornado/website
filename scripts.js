...
class NavigationManager {
    ...
    toggleMenu() {
        ...
        gsap.set(this.navLinks, { visibility: "visible" });  // ✅ Ensure elements are visible before animation
    ...
    handleScroll() {
        ...
        window.addEventListener('scroll', () => {
            ...
            this.header.classList.toggle('nav-scrolled', currentScroll > 50);
        });
    }
...
document.addEventListener("DOMContentLoaded", () => {
        ...
        onComplete: () => {
            setTimeout(() => {
                ...
                gsap.to(loader, {
                    ...
                    duration: 0.5,
                    onComplete: () => {
                        loader.classList.add("hidden");  // ✅ Smooth hide
                        setTimeout(() => {
                            loader.style.display = "none";
                            document.body.style.overflow = "";
                        }, 300);  // Extra delay to ensure smooth transition
                    }
                });
            }, 1000);
        }
    ...
    // Animate loader text and spinner
    tl.to(loaderText, { opacity: 1, duration: 1, ease: "power3.out" })
      .to(spinner, { opacity: 1, duration: 1 }, "-=0.5"); // Overlap animation
